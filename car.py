...
fuel_type = col1.selectbox("Select the fuel type",["Diesel","Petrol","LPG","Electric"])
...
seats = col2.selectbox("Enter the number of seats",[4,7,9,11])
encode_dict = {
        "fuel_type":{'Diesel':1,'Petrol':2,'LPG':3,'Electric':5},
